    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-sm bg-dark shadow navbar-dark fixed-top py-3">
            <div class="container-fluid">
                ...
                <a class="navbar-brand text-light mx-3" href="#">SERVICES</a>
                <div class="offcanvas offcanvas-start bg-dark text-white" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title ms-3 mt-3" id="offcanvasWithBothOptionsLabel">SERVICES</h5>
        ...
        <div class="col py-2 shadow rounded mx-5 card">
            ...
            <div class="row align-items-end">
                ...
                <div class="col mx-2 ps-4">
                    <a class="btn btn-dark" href="add_service.php">Add Service</a>
                </div>
                <div class="col mx-2">
                ...
                <table class="table"">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <td>$row[duration]</td>
                            <td>
                                <a class='fs-4 bi-pencil-square mx-1' style='color: black' href='/appointment_system/edit_service.php?service_id=$row[service_id]'></a>
                                <a class='fs-4 bi-trash3-fill mx-1' style='color: red' href='/appointment_system/edit_service.php?service_id=$row[service_id]'></a>
                            </td>
                            </tr>
                            ";
                        }
