        ...
        <div class="col py-2 shadow rounded mx-5 card">
            ...
            <div class="col">
                <div class="col pt-2 mx-4">
                    <h3 class="text-start">Appointments</h3>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <select class="form-control" name="sort_field" id="sort_field">
                                ...
                                <option value="barber_id">Barber ID</option>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            $query = "SELECT * FROM appointments WHERE date_time LIKE '%$search_term%' ORDER BY $sort_field $sort_dir";
                        } else if (isset($_GET['search_item'])) {
                            $search_term = $_GET['search_item'];
                            $query = "SELECT * FROM appointments WHERE 
                                appointment_id LIKE '%$search_term%' OR 
                                date_time LIKE '%$search_term%' OR 
                                expected_end_time LIKE '%$search_term%' OR 
                                status LIKE '%$search_term%' OR 
                                user_id LIKE '%$search_term%' OR 
                                barber_id LIKE '%$search_term%' OR 
                                payment_id LIKE '%$search_term%' OR 
                                created_at LIKE '%$search_term%'";
                        } else {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <td>
                                <a class='fs-4 bi-pencil-square mx-1' style='color: black' href='/appointment_system/edit_appointment.php?appointment_id=$row[appointment_id]'></a>
                                <a class='fs-4 bi-trash3-fill mx-1' style='color: red' href='/appointment_system/delete_appointment.php?appointment_id=$row[appointment_id]'></a>
                            </td>
                            </tr>
                            ";
                        }
