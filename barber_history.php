                ...
                <table class="table"">
                    ...
                    <tbody>
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            WHERE appointments.barber_id = '$user_id' AND (date_time LIKE '%$search_term%' OR status LIKE '%$search_term%' OR fname LIKE '%$search_term%' OR lname LIKE '%$search_term%')
                            ...
                            $query = "SELECT appointments.appointment_id, appointments.date_time, appointments.status, users.fname, users.lname FROM appointments 
                                INNER JOIN users ON appointments.user_id = users.user_id 
                                WHERE appointments.barber_id = '$user_id' AND (date_time LIKE '%$search_term%' OR 
                            ...
                            $query = "SELECT appointments.appointment_id, appointments.date_time, appointments.status, users.fname, users.lname FROM appointments 
                            INNER JOIN users ON appointments.user_id = users.user_id 
                            WHERE appointments.barber_id = '$user_id'";
                        }
